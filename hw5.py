...
def update_hand(hand, word):
    ...
    for letter in hand:
        hand_new[letter] = hand[letter];
    
    # TO DO ...
    for n in range(len(word)):
        hand_new[word[n]] = hand_new[word[n]] - 1;
        # print hand_new
        # print hand
...
def is_valid_word(word, hand, word_list):
    ...
    for n in range(len(word)):
        xx = hand.get(word[n],0);
        if xx == 0:
            inhand = 0;
            break

    if inhand == 1:
        y = update_hand(hand,word);
        # print y
      
        for letter in y.keys():
            if y[letter] < 0:
                inhand = 0;
                break
